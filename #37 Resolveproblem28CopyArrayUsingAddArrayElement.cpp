...
void CopyArrayUsingAddArrayElement (unsigned int soursearray[100],unsigned short sourcelength,unsigned int destnationarray[100],unsigned short &destnationlength){
...
int main (){
    ...
    CopyArrayUsingAddArrayElement(array1,length1,array2,length2);
