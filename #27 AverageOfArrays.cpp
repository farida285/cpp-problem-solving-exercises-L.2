 // Write a program to read array length with max size 100 and fill array with random numbers from 1 to 100 ,then print Array of array
#include <iostream>
#include <cstdlib>
#include <ctime>
using namespace std ;
...
float AverageOfArray (unsigned int array[100],unsigned short length){
    return ((float)SumOfArray(array,length)/length) ;
}
int main (){
    ...
    cout<<"Array elements : " ;
    PrintArray(x,length) ;
    cout<<"Average of elements is : "<<AverageOfArray (x,length) ;
    return 0 ;
}