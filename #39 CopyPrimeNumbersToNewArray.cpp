...
void CopyPrimeArrayElementsUsingAddArrayElement (unsigned int soursearray[100],unsigned short sourcelength,unsigned int destnationarray[100],unsigned short &destnationlength){
      for(unsigned short i =0 ;i<sourcelength;i++){
        if(CheckPrimeOrNot(soursearray[i])){
...
int main (){
    ...
    CopyPrimeArrayElementsUsingAddArrayElement(array1,length1,array2,length2);
