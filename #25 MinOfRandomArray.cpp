// Write a program to read array length with max size 100 and fill array with random numbers from 1 to 100 ,then print minimum number of array
#include <iostream>
#include <cstdlib>
#include <ctime>
using namespace std ;
...
int main (){
    ...
    cout<<"Array elements : " ;
    PrintArray(x,length) ;
    cout<<"Min element is : "<<MaxOfArray (x,length) ;
    return 0 ;
}